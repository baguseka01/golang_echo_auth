...
import (
	...
	"github.com/baguseka01/golang_echo_mongodb/models"
	"github.com/baguseka01/golang_echo_mongodb/responses"
...
func CreateUser(c echo.Context) error {
	...
	return c.JSON(http.StatusCreated, responses.UserResponse{Status: http.StatusCreated, Message: "Success create user", Data: &echo.Map{"data": newUser, "docId": result}})
}
...
func DetailUser(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, &echo.Map{"message": "Detail user", "user": user})
}
...
func UpdateUser(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, echo.Map{"message": "Success update user", "user": updatedUser})
}
...
func DeleteUser(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, echo.Map{"message": "Success delete user", "user": result})
}
...
func GetAllUser(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, echo.Map{"message": "All users", "user": users})
}
